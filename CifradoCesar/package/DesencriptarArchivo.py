...
def DesencriptarArchivo(clave):
	nombre_entrada 	= input("nombre del archivo Encritado: ") #nombre del archivo
	nombre_salida 	= input("como lo llamara al salir desencriptado: ")#nombre que se utilizara para la salida
